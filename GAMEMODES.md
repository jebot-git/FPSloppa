...
**CQ — CONQUEST (isolated experiment):** two teams of up to 32, sixteen territories, four corner homebases, prerequisite perimeter captures, nearest-friendly-district respawns, local district radio and UT99 equipment. Only the separate CQ launch profile can join its servers. See [CQ rules and launcher](docs/CONQUEST.md); the independent worker backend is not yet integrated.
