...
for target in ['Quest', 'Pico']:
    ...
    with zipfile.ZipFile(apk) as z:
        ...
        for script in ['modes/assault.gd', 'modes/fortress_fx.gd', 'maps/train_motion.gd', 'chainsaw.gd', 'vr/swim_strokes.gd', 'vr/t_pose.gd', 'audio/announcer.gd', 'network/disk_worker.gd', 'network/asset_jobs.gd', 'maps/contents.gd', 'maps/filtering.gd', 'ui/drag_scroll.gd', 'voice/preferences.gd', 'movement/quake.gd', 'voice/microphone.gd', 'voice/visemes.gd', 'modes/lobby_mirror.gd', 'modes/lobby_wall.gd', 'modes/match_selector.gd', 'ui/choice.gd', 'network/loading.gd', 'network/loading_overlay.gd', 'projectile_targets.gd', 'maps/network.gd', 'interface.gd', 'arena.gd', 'assets/paths.gd', 'assets/panel.gd', 'maps/uploads.gd', 'modes/special.gd', 'melee.gd', 'server/config.gd', 'server/log.gd', 'modes/match.gd', 'modes/votes.gd', 'audio/steam_backend.gd', 'avatars/network.gd', 'vr/preferences.gd', 'vr/tracking.gd', 'vr/status_hud.gd', 'vr/permissions.gd', 'vr/rig.gd', 'voice/chat.gd', 'voice/panel.gd', 'avatars/library.gd', 'avatars/rig.gd', 'avatars/pose.gd', 'fighter.gd', 'effects/combat.gd', 'audio/spatial.gd', 'audio/music/player.gd', 'pickups/models.gd', 'settings/preferences.gd', 'settings/panel.gd']:
