...
func run() -> void:
 ...
 for item in [[Vector3(18,2.2,24),Vector3(-8,12,-28),"nave"],[Vector3(7,9.7,-50),Vector3(9.5,9.2,-58.5),"sanctuary"],[Vector3(2,1.8,-34),Vector3(14,13,-44),"bell-lifts"],[Vector3(30,22,48),Vector3(0,6,0),"overview"]]:
