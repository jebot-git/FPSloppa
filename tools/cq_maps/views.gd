...
func run():
	...
	var car: Array=layout.props.filter(func(p):return p.kind=="parked_vehicle" or p.kind=="freight_vehicle")[0].position;var street:=Vector3(car[0],0,car[2])
	...
	for view in [["street",street+Vector3(9,2.1,6),street+Vector3.UP],["plaza",Vector3(21,2,21),Vector3(-70,17,-70)],["interior",c+Vector3(0,2,-d+3),c+Vector3(0,7,0)],["gallery",c+Vector3(0,7,-d-1.5),Vector3(0,2,0)],["aerial",Vector3(115,90,115),Vector3(0,4,0)]]:
