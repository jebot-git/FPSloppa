...
Gaze and measured blinks are cosmetic and replicate with the existing XR pose snapshots. All peers must use protocol `entryway-dm-7-eyes`. Eye tracking never affects aim, collision or damage.
