...
func _initialize() -> void:
	...
	while not stack.is_empty():
		...
		for file in DirAccess.get_files_at(folder):
			...
			if folder.contains("docs/audio") or folder.contains("deathmatch/audio/music/samples") or folder.contains("optional-arena-pack") or folder.contains("optional-ad-tools") or folder.contains("optional-threewave-tools") or folder.contains("optional-tf-tools"):failures.append(path)
