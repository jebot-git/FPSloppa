...
func _initialize() -> void:
	...
	for required in ["res://deathmatch/lag_compensation.gd","res://deathmatch/maps/static_batch.gd","res://deathmatch/maps/librequake-props/flame.json","res://deathmatch/maps/librequake-props/LICENCE.txt","res://deathmatch/maps/librequake-props/CREDITS.txt","res://deathmatch/maps/librequake-props/SOURCES.json"]:
