extends Node
const TRACKS={"title":"dead_air","lobby":"please_hold","dm":"iron_circuit","tdm":"pressure_lock","ctf":"dark_relay","koth":"high_ground","ig":"foundry_run","if":"cryostasis","ft":"cryostasis","cc":"carousel_of_teeth","tf":"breach_protocol","tb":"escape_velocity","as":"mega_destruction"}
var game
