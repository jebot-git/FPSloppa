...
const COLORS = [Color("b99170"),Color("ebae42"),Color("d4cfc4"),Color("d29c55"),Color("eac06e"),Color("e4bb56"),Color("ff7849"),Color("69ccff"),Color("92f56b")]
